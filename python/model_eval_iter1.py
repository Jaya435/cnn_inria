...
def train_eval(train_loader, valid_loader, n_epochs, model, optimizer):
    ...
    for epoch in range(1, n_epochs+1):
        ...
        if valid_loss <= valid_loss_min:
            ...
            valid_loss_min,
            valid_loss))
            torch.save(model.state_dict(), '/exports/csce/eddie/geos/groups/geos_cnn_imgclass/data/saved_models/grid_search/model_inria_batch{}_lr{}_arch{}_epochs{}.pt'.format(
...
def model_eval(test_loader,net):
    ...
    with torch.no_grad():
        ...
        stop = time.time()   
        result = ('Accuracy: {:.3f} %, Time: {:.2f}s, Batch_Size: {}, Learning Rate: {}, Initial Architecture: {}'.format(((100 * correct / total,stop-start),args.batch_size, args.lr, args.arch_size)))
        print (result)
if __name__ == "__main__":
    ...
    if torch.cuda.device_count() > 1:
        ...
        plt.savefig('lr{}net_size{}batch{}epochs{}.png'.
            format(args.lr,args.arch_size,args.batch_size,args.num_epochs))
    else:
        net.to(device)
    ...
    net = nn.DataParallel(net)
    net.to(device)
    net.load_state_dict(torch.load('/exports/csce/eddie/geos/groups/geos_cnn_imgclass/data/saved_models/grid_search/model_inria_batch{}_lr{}_arch{}_epochs{}.pt'.format(args.batch_size,args.lr,args.arch_size,args.num_epochs)))
