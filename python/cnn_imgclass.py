...
image_paths = glob.glob('/exports/csce/eddie/geos/groups/geos_cnn_imgclass/data/inria_test/test/images/*.tif')
target_paths = glob.glob('/exports/csce/eddie/geos/groups/geos_cnn_imgclass/data/inria_test/test/images/*.tif')
...
net.to(device)
lr,net.cr,batch_size,num_epochs= 0.001,32,128,100
...
plt.savefig('lr{}net_size{}batch{}epochs{}.png'.
            format(lr,net.cr,batch_size,num_epochs))
